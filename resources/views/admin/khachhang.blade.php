...
<div class="container-fluid">
	<div class="main-card card">
		<div class="card-body" style="background-color: #59afec;">
			<div class="d-flex">
				<h5 class="text-white">DANH SÁCH KHÁCH HÀNG</h5>
			</div>
		</div> 
	</div>
			...
			<table class="table table-bordered" align="center" id="myTable">
				...
				<tbody>
					...
					<tr>
						...
						<td>{{$kh->email}}</td>
						<td>
							<button class="btn btn-warning" data-toggle="modal" data-target="#modelChangePassword" id="changePW">
							...
							<a href="{{ route('admin.infoKH.get',$kh->kh_ma) }}">
